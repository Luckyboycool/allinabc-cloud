 ...
 * @Date 2021/4/7 18:03
 **/
@Service("node_decision_C_N")
@Slf4j
public class EntrustDisAgreeService implements DecisionAdapt {
    ...
    public List<String> complateTask(ProcessInstance processInstance, ProcessExecuteParam processExecuteParam, Task currentTask, User currentUser,String basicInfoId, Map<String, Object> variables) {
        //驳回
        log.info("加签的驳回");
        bizAuditService.addComment(processInstance, processExecuteParam, DecisionConstant.ENTRUST_DISAGREE, currentTask, null, null,variables);
