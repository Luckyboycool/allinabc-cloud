 ...
 * @Date 2021/4/7 18:03
 **/
@Service("node_decision_C_Y")
@Slf4j
public class EntrustAgreeService implements DecisionAdapt {
    ...
    public List<String> complateTask(ProcessInstance processInstance, ProcessExecuteParam processExecuteParam, Task currentTask, User currentUser, String basicInfoId, Map<String, Object> variables) {
        log.info("加签同意");
        bizAuditService.addComment(processInstance, processExecuteParam, DecisionConstant.ENTRUST_AGREE, currentTask, null, null, variables);
